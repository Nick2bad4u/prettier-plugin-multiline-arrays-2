        ...
        [
            {
                ...
                inputs: ["multilineArraysWrapThreshold", -1],
                expect: true,
            },
            {
                it: "allows numbers for multilineArraysWrapThreshold",
                inputs: ["multilineArraysWrapThreshold", 63],
                expect: true,
            },
            {
            ...
            },
            {
                ...
                inputs: ["multilineArraysLinePattern", "63"],
                expect: true,
            },
            {
                it: "rejects non-numeric strings for multilineArraysLinePattern",
                inputs: ["multilineArraysLinePattern", "63 keys"],
                expect: false,
            },
        ]
    );
